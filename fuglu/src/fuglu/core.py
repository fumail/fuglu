...
class AllpluginTestCase(unittest.TestCase):
    ...
    def test_writeheaders(self):
        import random
        suspect = Suspect(
            "oli@unittests.fuglu.org", "recipient@unittests.fuglu.org", "testdata/helloworld.eml")
        ...
        # print msgsource
        self.failUnless(
            newrep['randomstuff'] == str(rnd), "Header was not written correctly")
...
class DKIMTestCase(unittest.TestCase):
    ...
    def testDKIM(self):
        ...
        dkimheader = sign(msgstring, 'whatever', 'testfuglu.org', open(
            'testdata/dkim/testfuglu.org.private').read(), include_headers=['From', 'To'])
